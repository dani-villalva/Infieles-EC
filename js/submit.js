...
// Separado a propósito del feed (feed.js): abre/cierra el modal,
// arma el formulario y escribe el post directamente en Firestore.
// ==========================================================
...
export function initSubmitPanel() {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        const newPost = {
            ...
            sads: 0,
            comentariosCount: 0,
            clientId: appState.clientId // para no auto-notificarnos nuestra propia publicación
        };
        ...
        try {
            ...
            alert('No se pudo publicar. Revisa tu conexión o la configuración de Firebase.');
        } finally {
